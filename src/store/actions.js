...
export const api_v1_animal_list = () => ({ type: types.API_V1_ANIMAL_LIST })
export const api_v1_animal_listSucceeded = (response, starter) => ({
  type: types.API_V1_ANIMAL_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_animal_listFailed = (response, starter) => ({
  type: types.API_V1_ANIMAL_LIST_FAILED,
  response,
  starter
})
export const api_v1_animal_create = data => ({
  type: types.API_V1_ANIMAL_CREATE,
  data
})
export const api_v1_animal_createSucceeded = (response, starter) => ({
  type: types.API_V1_ANIMAL_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_animal_createFailed = (response, starter) => ({
  type: types.API_V1_ANIMAL_CREATE_FAILED,
  response,
  starter
})
export const api_v1_animal_read = () => ({ type: types.API_V1_ANIMAL_READ })
export const api_v1_animal_readSucceeded = (response, starter) => ({
  type: types.API_V1_ANIMAL_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_animal_readFailed = (response, starter) => ({
  type: types.API_V1_ANIMAL_READ_FAILED,
  response,
  starter
})
export const api_v1_animal_update = data => ({
  type: types.API_V1_ANIMAL_UPDATE,
  data
})
export const api_v1_animal_updateSucceeded = (response, starter) => ({
  type: types.API_V1_ANIMAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_animal_updateFailed = (response, starter) => ({
  type: types.API_V1_ANIMAL_UPDATE_FAILED,
  response,
  starter
})
export const api_v1_animal_partial_update = data => ({
  type: types.API_V1_ANIMAL_PARTIAL_UPDATE,
  data
})
export const api_v1_animal_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_ANIMAL_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_animal_partial_updateFailed = (response, starter) => ({
  type: types.API_V1_ANIMAL_PARTIAL_UPDATE_FAILED,
  response,
  starter
})
export const api_v1_animal_delete = () => ({ type: types.API_V1_ANIMAL_DELETE })
export const api_v1_animal_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_ANIMAL_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_animal_deleteFailed = (response, starter) => ({
  type: types.API_V1_ANIMAL_DELETE_FAILED,
  response,
  starter
})
