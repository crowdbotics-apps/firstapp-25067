...
function* api_v1_animal_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_animal_list, action)
    yield put(actions.api_v1_animal_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_animal_listFailed(err, action))
  }
}
function* api_v1_animal_listWatcher() {
  yield takeEvery(types.API_V1_ANIMAL_LIST, api_v1_animal_listWorker)
}
function* api_v1_animal_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_animal_create, action)
    yield put(actions.api_v1_animal_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_animal_createFailed(err, action))
  }
}
function* api_v1_animal_createWatcher() {
  yield takeEvery(types.API_V1_ANIMAL_CREATE, api_v1_animal_createWorker)
}
function* api_v1_animal_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_animal_read, action)
    yield put(actions.api_v1_animal_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_animal_readFailed(err, action))
  }
}
function* api_v1_animal_readWatcher() {
  yield takeEvery(types.API_V1_ANIMAL_READ, api_v1_animal_readWorker)
}
function* api_v1_animal_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_animal_update, action)
    yield put(actions.api_v1_animal_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_animal_updateFailed(err, action))
  }
}
function* api_v1_animal_updateWatcher() {
  yield takeEvery(types.API_V1_ANIMAL_UPDATE, api_v1_animal_updateWorker)
}
function* api_v1_animal_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_animal_partial_update, action)
    yield put(actions.api_v1_animal_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_animal_partial_updateFailed(err, action))
  }
}
function* api_v1_animal_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_ANIMAL_PARTIAL_UPDATE,
    api_v1_animal_partial_updateWorker
  )
}
function* api_v1_animal_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_animal_delete, action)
    yield put(actions.api_v1_animal_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_animal_deleteFailed(err, action))
  }
}
function* api_v1_animal_deleteWatcher() {
  yield takeEvery(types.API_V1_ANIMAL_DELETE, api_v1_animal_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    api_v1_animal_listWatcher,
    api_v1_animal_createWatcher,
    api_v1_animal_readWatcher,
    api_v1_animal_updateWatcher,
    api_v1_animal_partial_updateWatcher,
    api_v1_animal_deleteWatcher,
