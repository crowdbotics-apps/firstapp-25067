...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.API_V1_ANIMAL_LIST:
    case types.API_V1_ANIMAL_LIST_SUCCEEDED:
      return Object.assign({}, state, {
        animals: [...state.animals, action.response]
      })
    case types.API_V1_ANIMAL_LIST_FAILED:
      return Object.assign({}, state, {
        firstAppAPI: [...state.firstAppAPI, action.response]
      })
    case types.API_V1_ANIMAL_CREATE:
    case types.API_V1_ANIMAL_CREATE_SUCCEEDED:
      return Object.assign({}, state, {
        animals: [...state.animals, action.response]
      })
    case types.API_V1_ANIMAL_CREATE_FAILED:
      return Object.assign({}, state, {
        firstAppAPI: [...state.firstAppAPI, action.response]
      })
    case types.API_V1_ANIMAL_READ:
    case types.API_V1_ANIMAL_READ_SUCCEEDED:
      return Object.assign({}, state, {
        animals: [
          ...state.animals.filter(record => record.id !== action.response.id),
          action.response
        ]
      })
    case types.API_V1_ANIMAL_READ_FAILED:
      return Object.assign({}, state, {
        firstAppAPI: [...state.firstAppAPI, action.response]
      })
    case types.API_V1_ANIMAL_UPDATE:
    case types.API_V1_ANIMAL_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        animals: state.animals.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    case types.API_V1_ANIMAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        firstAppAPI: [...state.firstAppAPI, action.response]
      })
    case types.API_V1_ANIMAL_PARTIAL_UPDATE:
    case types.API_V1_ANIMAL_PARTIAL_UPDATE_SUCCEEDED:
      return Object.assign({}, state, {
        animals: state.animals.map(record =>
          record.id === action.response.id ? action.response : record
        )
      })
    case types.API_V1_ANIMAL_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        firstAppAPI: [...state.firstAppAPI, action.response]
      })
    case types.API_V1_ANIMAL_DELETE:
    case types.API_V1_ANIMAL_DELETE_SUCCEEDED:
    case types.API_V1_ANIMAL_DELETE_FAILED:
      return Object.assign({}, state, {
        firstAppAPI: [...state.firstAppAPI, action.response]
      })
